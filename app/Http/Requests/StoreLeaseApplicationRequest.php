...
class StoreLeaseApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'applicant_type' => ['required', Rule::in(['individual', 'company'])],
            'company_name' => ['nullable', 'required_if:applicant_type,company', 'string', 'max:255'],
    ...
    public function messages(): array
    {
        return [
            ...
            'company_name.required_if' => 'Company name is required for company applicants.',
            'proposed_end_date.after' => 'The end date must be after the start date.',
            'proposed_start_date.after_or_equal' => 'The start date cannot be in the past.',
        ];
    }
}
