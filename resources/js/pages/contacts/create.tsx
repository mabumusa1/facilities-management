        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Add a new {data.contact_type}</p>
                </div>

                <Card className="max-w-2xl">
                    <CardHeader>
                        <CardTitle>Contact Details</CardTitle>
                        <CardDescription>Enter the contact information</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                {errors.contact_type && (
                                    <p className="text-destructive text-sm">{errors.contact_type}</p>
                                )}
                            </div>
