...
watchEffect(() => {
    setLayoutProps({
        breadcrumbs: [
            ...
            { title: t('app.contacts.professionals.newProfessional'), href: '/professionals/create' },
        ],
    });
});
...
<template>
    <Head :title="t('app.contacts.professionals.newProfessional')" />
    <div class="flex flex-col gap-6 p-4">
        <Heading variant="small" :title="t('app.contacts.professionals.createTitle')" :description="t('app.contacts.professionals.createDescription')" />
