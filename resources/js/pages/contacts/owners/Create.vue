...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'New Owner', href: '/owners/create' },
        ],
    },
});
...
<template>
    ...
    <div class="flex flex-col gap-6 p-4">
        <Heading variant="small" title="Create Owner" description="Add a new property owner." />
        ...
        <form @submit.prevent="submit" class="max-w-2xl space-y-6">
            ...
            <div class="flex items-center gap-4">
                <Button :disabled="form.processing">Create Owner</Button>
            </div>
        </form>
    </div>
</template>
