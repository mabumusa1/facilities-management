...
import { index as communitiesIndex, store as communitiesStore } from '@/routes/communities';
        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Add a new community to your properties</p>
                </div>

                <Card className="max-w-2xl">
                    <CardHeader>
                        <CardTitle>Community Details</CardTitle>
                        <CardDescription>Enter the basic information for the new community</CardDescription>
                    </CardHeader>
                    <CardContent>
