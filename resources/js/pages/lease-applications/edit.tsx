...
export default function ApplicationEdit({
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        units: application.units.map((u) => ({
            id: u.id,
            proposed_rental_amount: u.pivot?.proposed_rental_amount
                ? parseFloat(u.pivot.proposed_rental_amount)
                : undefined,
            net_area: u.pivot?.net_area
                ? parseFloat(u.pivot.net_area)
                : undefined,
            meter_cost: u.pivot?.meter_cost
                ? parseFloat(u.pivot.meter_cost)
                : undefined,
        })),
        ...
        proposed_start_date: application.proposed_start_date
            ? application.proposed_start_date.split("T")[0]
            : "",
        proposed_end_date: application.proposed_end_date
            ? application.proposed_end_date.split("T")[0]
            : "",
        proposed_duration_months:
            application.proposed_duration_months?.toString() || "",
        ...
        setData(
            ...
            newSelected.map((id) => {
                ...
                return (
                    existing || {
                        id,
                        proposed_rental_amount: undefined,
                        net_area: undefined,
                        meter_cost: undefined,
                    }
                );
            }),
        );
                        ...
                        <div className="space-y-6 lg:col-span-2">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Update the proposed lease terms
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div className="grid gap-4 sm:grid-cols-2">
