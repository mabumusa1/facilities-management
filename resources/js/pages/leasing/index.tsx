...
const modules = [
    {
        title: "Leases",
        description:
            "Manage main lease contracts, creation wizard, and lifecycle.",
        href: "/leases",
        icon: FileText,
        color: "text-blue-600",
        bg: "bg-blue-50",
...
export default function LeasingIndex({
    stats,
    recentLeases,
    expiringLeases,
}: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Overview of all leasing activity — leases, sub-leases,
                        and applications
                    </p>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {stats.sub_leases.total}
                            </div>
                            <p className="text-xs text-muted-foreground">
                                {stats.sub_leases.active} active
                            </p>
                        </CardContent>
                    </Card>
                    <Card>
                            ...
                            <Link key={title} href={href}>
                                <Card className="cursor-pointer hover:shadow-md transition-shadow h-full">
                                    <CardContent className="p-6">
                                        <div
                                            className={`inline-flex p-3 rounded-lg ${bg} mb-4`}
                                        >
                                            <Icon
                                        ...
                                        <div
                                            className={`flex items-center gap-1 mt-3 text-sm font-medium ${color}`}
                                        >
                                            View{" "}
...
LeasingIndex.layout = {
    breadcrumbs: [{ title: "Leasing", href: "/leasing" }],
};
