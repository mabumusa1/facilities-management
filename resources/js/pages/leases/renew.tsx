            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Create a new lease from{" "}
                            {originalLease.contract_number}
                        </p>
                    </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Review the original lease details before renewal
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="grid gap-4 md:grid-cols-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium">
                                        {formatCurrency(
                                            originalLease.rental_total_amount,
                                        )}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div>
                            <p className="text-sm font-medium mb-2">
                                Units ({originalLease.units.length})
                            </p>
                ...
                <form onSubmit={handleSubmit}>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Configure the renewed lease terms
                            </CardDescription>
                        </CardHeader>
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-4 rounded-lg border border-blue-200 bg-blue-50 p-4">
                                            ...
                                            <ul className="text-sm text-blue-800 list-disc list-inside mt-2">
                                                ...
                                                <li>
                                                    Mark the original lease as
                                                    renewed
                                                </li>
                                                <li>
                                                    Keep the same tenant (
                                                    {originalLease.tenant?.name}
                                                    )
                                                </li>
                                                <li>
                                                    Retain the units with
